...
const jobs = [
    {
        ...
        message: () => "It's 10 PM, tulog na kamo kong wala man lang kamo sang gina pulawan mga mango kamo HAHAHAHA",
    },
    {
        time: "21 22 * * *", // every day at 22:21 (10:21 PM)
        message: () => "It's 10:21 PM, good night!",
        targetIDs: ["100038167551355"], // list of ids that bot will send to, remove this to send to all group
    },
];
